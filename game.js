...
class Snake{
    ...
    move(){
        ...
        //updating the start of the tail
    ...
    //changing the direction of the movement of the snake
    dir(dirX,dirY){
        this.velX=dirX;
        this.velY=dirY;
    }

    //whether the snake has eaten a piece of food.
    eat(){
    ...
    //checks if the snake is within the bounds of the screen.
    border(){
